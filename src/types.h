...
inline Value RookValue    = 1213;
inline Value AdvisorValue = 216;
inline Value CannonValue  = 746;
inline Value PawnValue    = 140;
inline Value KnightValue  = 964;
inline Value BishopValue  = 191;
